...
<body>
    <div class="container-fluid vh-100">
            ...
            <div class="col-md-12 bg-primary py-2">
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="#">
                            <div class="media">
                                <img class="align-self-center mr-3"
                                    src="https://upload.wikimedia.org/wikipedia/id/thumb/a/a6/Duta_Wacana.svg/600px-Duta_Wacana.svg.png"
                        ...
                        <a class="dropdown-item border-top" href="/user"><i class="bi bi-gear-fill"></i> Data
                            Pengguna</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-primary py-4">
                {{-- Contents --}}
                @livewire('form-task')
                @livewire('table-task')
            </div>
